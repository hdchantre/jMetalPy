...
from my_mecrlp_problemv3 import *
...
if __name__ == '__main__':
    ...
    #U1 = {int(sys.argv[1])}
    U1 = {int(sys.argv[1]),int(sys.argv[2]),int(sys.argv[3]),int(sys.argv[4])}
    #V1 = {int(sys.argv[2])}
    V1 = {int(sys.argv[5]),int(sys.argv[6]),int(sys.argv[7]),int(sys.argv[8]),int(sys.argv[9])}
    K1 = {3,4,5,6,7}
    #K1 = {3,4}
    N1 ={int(sys.argv[10]),int(sys.argv[11]),int(sys.argv[12]),int(sys.argv[13])}
    #N1 = {int(sys.argv[3])}
                    ...
                    for ru in r_u1:
                        for rv in R_v1:
                            for k in K1:
                                ...
                                output_directory = '/data1NK/'+str(u)+"/"+str(n)+"/"+str(v)+"/"+str(lv)+"/"+str(ru)+"/"+str(rv)+"/"+str(k)+"/"
